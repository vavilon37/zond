...
HELP_TEXT = (
    ...
    "<b>📊 Про пинг в Happ:</b>\n"
    "Цифра пинга в приложении (часто показывает 500-1500мс) — "
    "<b>не реальная задержка</b> твоего трафика. Это измерение TCP-handshake через Reality "
    "и зависит от маршрута твоего провайдера до сервера. На реальную скорость, "
    "видео и игры почти не влияет.\n"
    "Проверить реальную скорость: открой <b>speedtest.net</b> с включённым VPN — там увидишь "
    "честный download и ping.\n\n"
    "🎁 <b>Бонусы в меню:</b>\n"
