...
HELP_TEXT = (
    ...
    "• Не помогло — пиши @yodealer\n\n"
    "<b>📊 Про пинг в Happ:</b>\n"
    "По умолчанию HAPP показывает пинг через прокси (часто 500-1500мс) — это <b>не реальная задержка</b>, "
    "а измерение полного handshake через Reality.\n"
    "<b>Чтобы увидеть настоящие 40-100мс:</b> Настройки → Пинг → выбери <b>«TCP»</b>. "
    "После этого нажми обновление пинга у сервера — цифра станет нормальной.\n"
    "Также проверить реальную скорость: <b>speedtest.net</b> с включённым VPN.\n\n"
    "🎁 <b>Бонусы в меню:</b>\n"
