...
WELCOME = (
    ...
    "📱 Приложение для подключения: <b>HAPP</b> (iOS/Android)\n\n"
...
HELP_TEXT = (
    ...
    "2. Открой «📋 Моя подписка» в этом боте и скопируй ссылку-подписку\n"
    "3. Запусти Happ\n"
    ...
    "VPN-профиля в настройках iOS — там подтверждай Touch ID / Face ID\n"
    ...
    "• Проверь что в списке появилась именно подписка (не пустая)\n"
    "• Попробуй переподключиться (выкл/вкл)\n"
    "• Перезайди в Happ, обнови подписку: открой её → «Update»\n"
    "• Если совсем не помогает — пиши админу\n\n"
    "🎁 <b>Бонусы в меню:</b>\n"
    "• «🎁 Пригласить друга» — +3 дня тебе и другу при первом запуске им бота по твоей ссылке\n"
    "• «🎟 Промокод» — введи <code>zondvpn</code> и получи 7 бесплатных дней\n\n"
